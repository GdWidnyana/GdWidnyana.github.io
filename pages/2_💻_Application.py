...
if (selected == 'hitung luas belah ketupat') :
    ...
    diagonal1 = st.number_input ("Masukan ukuran diagonal 1", .0)
    diagonal2 = st.number_input ("Masukan ukuran diagonal 2", .0)
    hitung = st.button ("Hitung luas")
    
    if hitung :
        luasBL = 0.5*diagonal1*diagonal2
        st.write ("luas bangun belah ketupat adalah ", luasBL)
        st.success (f"Kesimpulan : luas bangun belah ketupat sesuai dengan ukuran diagonal satu : {diagonal1} cm dan diagonal dua : {diagonal2} cm adalah {luasBL} cm2")
        st.balloons()
...
if (selected == 'hitung luas permukaan kubus') :
    ...
    if hitung :
        ...
        st.success (f"Kesimpulan : luas permukaan kubus dengan sisi {sisi} cm adalah {LP} cm2")
        st.snow()
...
if (selected == 'hitung luas permukaan balok') :
    ...
    if hitung :
        ...
        st.success (f"Kesimpulan : luas permukaan balok dengan panjang {panjang} cm, lebar {lebar} cm, tinggi {tinggi} cm adalah {LP} cm2")
        st.balloons()
